...
fun ImageView.bindImage(
    ...
    Glide.with(this).load(url).apply {
        apply(RequestOptions().apply {
            when{
                placeholderRes != null -> placeholder(context.resources.getDrawable(placeholderRes))
                fallbackRes != null -> fallback(context.resources.getDrawable(fallbackRes))
                errorRes != null -> error(context.resources.getDrawable(errorRes))
            }
